            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">jcoulombe_@hotmail.com</span>

                        <a href="mailto:jcoulombe_@hotmail.com" className="contact__button">
                            Contact me{""}
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">450-944-7882</span>
